  ...
  return (
    <div>
      <div className="bg-[url('/src/quiz.jpg')] bg-no-repeat bg-cover h-[560px] mb-6 flex flex-col justify-center items-center brightness-80 min-h-screen">
        <h1 className='text-5xl font-bold text-white'>Welcome To The Online Quiz</h1>
        <p className='text-xl text-yellow-500 mt-2'>Lets Start Your Online Journey With Quiz....</p>
      </div>
